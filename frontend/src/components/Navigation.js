          ...
          <div className="d-lg-flex justify-content-between align-items-center w-100">
            <ul className="navbar-nav mx-auto">
              <li className="nav-item mx-lg-2">
                <Link className="nav-link rounded-pill px-3" to="/">Home</Link>
              </li>
              <li className="nav-item mx-lg-2">
                <Link className="nav-link rounded-pill px-3" to="/services">Find Assemblers</Link>
              </li>
              <li className="nav-item mx-lg-2">
                <Link className="nav-link rounded-pill px-3" to="/projects">Browse Projects</Link>
              </li>
            </ul>
              ...
              {user ? (
                ...
                <div className="d-flex">
                  ...
                  <li className="nav-item">
                    <Link className="btn btn-primary rounded-pill px-3" to="/register">Sign Up</Link>
                  </li>
                </div>
              )}
            </ul>
