      ...
      <div className="row mb-4">
        <div className="col">
          ...
          <p className="text-muted">
            Find skilled assemblers to help with your furniture
          </p>
        </div>
      </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-3">
                          <div>
                            ...
                            <span className="d-block">
                              <i className="bi bi-briefcase me-1"></i> {service.experience_years} {service.experience_years === 1 ? 'year' : 'years'} experience
                            </span>
                          </div>
                          ...
                          {service.provider_rating > 0 && (
                            <div className="text-warning">
                              {[...Array(5)].map((_, i) => (
                                <i key={i} className={`bi ${i < Math.round(service.provider_rating) ? 'bi-star-fill' : 'bi-star'}`}></i>
                              ))}
                            </div>
                          )}
                        </div>
